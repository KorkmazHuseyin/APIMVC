...
namespace APIMVC.MyApis
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<MyContext>(a=>a.UseSqlServer("server=.;Database=Northwind;uid=sa;pwd=123"));
            services.AddDbContext<AuthContext>(a=>a.UseSqlServer("server=.;Database=Northwind;uid=sa;pwd=123"));

            services.AddAutoMapper(typeof(Startup));

            services.AddScoped<IAuthDAL,IAuthDAL>();
